...
public class Hotel {
    ...
    public User login(String username, String password) {
        ...
        users[0] = new User("Admin", "AdminHotel", true); // Admin
        users[1] = new User("Dara Afrilia Rinjani", "140405", false);
        users[2] = new User("Anisa Dealova", "120405", false);
        users[3] = new User("Abu Bakar", "130405", false);
        users[4] = new User("Lita Ramli", "150405", false);
        users[5] = new User("Fajar Marsono", "160405", false);
